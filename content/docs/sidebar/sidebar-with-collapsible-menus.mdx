---
title: Sidebar With Collapsible Menus
description: Sidebar With Collapsible Menus component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/sidebar/sidebar-with-collapsible-menus/index.html" title="Sidebar With Collapsible Menus" interaction="click" />

## Source

Source component: `sidebar/sidebar-with-collapsible-menus.html`
