...
description: With User Profile component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/navbar/with-user-profile/index.html" title="With User Profile" interaction="click" />

## Source

Source component: `navbar/with-user-profile.html`

```html
<nav x-data="{ mobileMenuIsOpen: false }" x-on:click.away="mobileMenuIsOpen = false" class="flex items-center justify-between px-6 py-4" aria-label="penguin ui menu">
	<!-- Brand Logo -->
