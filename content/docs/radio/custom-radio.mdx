---
title: Custom Radio
description: Custom Radio component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/radio/custom-radio/index.html" title="Custom Radio" />

## Source

Source component: `radio/custom-radio.html`
