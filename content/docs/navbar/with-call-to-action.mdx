...
description: With Call To Action component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/navbar/with-call-to-action/index.html" title="With Call To Action" interaction="click" />

## Source

Source component: `navbar/with-call-to-action.html`
