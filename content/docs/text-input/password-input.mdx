...
description: Password Input component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/text-input/password-input/index.html" title="Password Input" interaction="click" />

## Source

Source component: `text-input/password-input.html`
