...
description: Context Menu Dropdown component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/dropdowns/context-menu-dropdown/index.html" title="Context Menu Dropdown" interaction="click-or-contextmenu" />

## Source

Source component: `dropdowns/context-menu-dropdown.html`
