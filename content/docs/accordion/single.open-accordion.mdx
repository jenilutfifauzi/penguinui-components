...
description: Single.open Accordion component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/accordion/single.open-accordion/index.html" title="Single.open Accordion" interaction="click" />

## Source

Source component: `accordion/single.open-accordion.html`
