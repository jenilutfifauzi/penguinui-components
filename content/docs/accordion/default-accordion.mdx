...
description: Default Accordion component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/accordion/default-accordion/index.html" title="Default Accordion" interaction="click" />

## Source

Source component: `accordion/default-accordion.html`
