...
description: Dropdown With Icons component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/dropdowns/dropdown-with-icons/index.html" title="Dropdown With Icons" interaction="click" />

## Source

Source component: `dropdowns/dropdown-with-icons.html`
