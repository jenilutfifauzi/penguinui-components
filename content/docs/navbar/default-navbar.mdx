...
description: Default Navbar component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/navbar/default-navbar/index.html" title="Default Navbar" interaction="click" />

## Source

Source component: `navbar/default-navbar.html`
