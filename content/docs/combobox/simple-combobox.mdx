...
description: Simple Combobox component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/combobox/simple-combobox/index.html" title="Simple Combobox" interaction="click" />

## Source

Source component: `combobox/simple-combobox.html`
