...
description: Carousel With Text component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/carousel/carousel-with-text/index.html" title="Carousel With Text" interaction="click" />

## Source

Source component: `carousel/carousel-with-text.html`
