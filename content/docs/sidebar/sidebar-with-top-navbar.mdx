---
title: Sidebar With Top Navbar
description: Sidebar With Top Navbar component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/sidebar/sidebar-with-top-navbar/index.html" title="Sidebar With Top Navbar" interaction="click" />

## Source

Source component: `sidebar/sidebar-with-top-navbar.html`
