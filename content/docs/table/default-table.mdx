---
title: Default Table
description: Default Table component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/table/default-table/index.html" title="Default Table" />

## Source

Source component: `table/default-table.html`
