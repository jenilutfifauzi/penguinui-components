---
title: Chat Display
description: Chat Display component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/ai-output-display/chat-display/index.html" title="Chat Display" />

## Source

Source component: `ai-output-display/chat-display.html`
