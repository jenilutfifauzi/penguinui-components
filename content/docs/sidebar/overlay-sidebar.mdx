...
description: Overlay Sidebar component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/sidebar/overlay-sidebar/index.html" title="Overlay Sidebar" interaction="click" />

## Source

Source component: `sidebar/overlay-sidebar.html`
