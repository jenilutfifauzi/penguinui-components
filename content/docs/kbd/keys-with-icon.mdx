---
title: Keys With Icon
description: Keys With Icon component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/kbd/keys-with-icon/index.html" title="Keys With Icon" />

## Source

Source component: `kbd/keys-with-icon.html`

```html
<!-- command -->
<kbd class="inline-block size-min whitespace-nowrap rounded-md border border-outline bg-surface-alt p-1 font-mono font-semibold text-on-surface dark:border-outline-dark dark:bg-surface-dark-alt dark:text-on-surface-dark">
