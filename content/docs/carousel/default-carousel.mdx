...
description: Default Carousel component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/carousel/default-carousel/index.html" title="Default Carousel" interaction="click" />

## Source

Source component: `carousel/default-carousel.html`
