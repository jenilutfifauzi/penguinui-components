...
description: Simple Sidebar component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/sidebar/simple-sidebar/index.html" title="Simple Sidebar" interaction="click" />

## Source

Source component: `sidebar/simple-sidebar.html`
