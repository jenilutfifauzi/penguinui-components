...
description: Combobox With Checkboxes component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/combobox/combobox-with-checkboxes/index.html" title="Combobox With Checkboxes" interaction="click" />

## Source

Source component: `combobox/combobox-with-checkboxes.html`
