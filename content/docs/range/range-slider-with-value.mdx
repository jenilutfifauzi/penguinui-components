...
description: Range Slider With Value component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/range/range-slider-with-value/index.html" title="Range Slider With Value" />

## Source

Source component: `range/range-slider-with-value.html`
