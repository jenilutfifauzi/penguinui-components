...
description: Testimonial Card component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/card/testimonial-card/index.html" title="Testimonial Card" />

## Source

Source component: `card/testimonial-card.html`
