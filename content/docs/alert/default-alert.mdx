---
title: Default Alert
description: Default Alert component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/alert/default-alert/index.html" title="Default Alert" />

## Source

Source component: `alert/default-alert.html`
