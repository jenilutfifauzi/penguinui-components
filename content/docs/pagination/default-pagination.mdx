...
description: Default Pagination component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/pagination/default-pagination/index.html" title="Default Pagination" />

## Source

Source component: `pagination/default-pagination.html`
