---
title: Phone Number Input With Country Code Dropdown
description: Phone Number Input With Country Code Dropdown component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/combobox/phone-number-input-with-country-code-dropdown/index.html" title="Phone Number Input With Country Code Dropdown" interaction="click" />

## Source

Source component: `combobox/phone-number-input-with-country-code-dropdown.html`
