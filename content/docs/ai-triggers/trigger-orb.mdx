---
title: Trigger Orb
description: Trigger Orb component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/ai-triggers/trigger-orb/index.html" title="Trigger Orb" />

## Source

Source component: `ai-triggers/trigger-orb.html`
