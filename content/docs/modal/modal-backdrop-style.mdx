---
title: Modal Backdrop Style
description: Modal Backdrop Style component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/modal/modal-backdrop-style/index.html" title="Modal Backdrop Style" interaction="click" />

## Source

Source component: `modal/modal-backdrop-style.html`
