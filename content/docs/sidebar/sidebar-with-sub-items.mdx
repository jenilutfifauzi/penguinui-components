---
title: Sidebar With Sub Items
description: Sidebar With Sub Items component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/sidebar/sidebar-with-sub-items/index.html" title="Sidebar With Sub Items" interaction="click" />

## Source

Source component: `sidebar/sidebar-with-sub-items.html`
...
<div x-data="{ showSidebar: false }" class="relative flex w-full flex-col md:flex-row">
    ...
    <nav x-cloak class="fixed left-0 z-20 flex h-svh w-60 shrink-0 flex-col border-r border-outline bg-surface-alt p-4 transition-transform duration-300 md:w-64 md:translate-x-0 md:relative dark:border-outline-dark dark:bg-surface-dark-alt" x-bind:class="showSidebar ? 'translate-x-0' : '-translate-x-60'" aria-label="sidebar navigation">
        ...
        <div class="flex flex-col gap-2 overflow-y-auto pb-6">
            ...
            <a href="#" target="_blank" class="flex items-center gap-2 px-2 py-1.5 text-sm rounded-radius font-medium text-on-surface underline-offset-2 hover:bg-primary/5 hover:text-on-surface-strong focus-visible:underline focus:outline-hidden dark:text-on-surface-dark dark:hover:bg-primary-dark/5 dark:hover:text-on-surface-dark-strong">
                <span>GitHub</span>
            ...
            <ul class="pl-4">
                <li class="border-l px-2 py-0.5 border-outline dark:border-outline-dark">
                    <a href="#" class="flex items-center gap-2 px-2 py-1.5 text-sm rounded-radius text-on-surface underline-offset-2 hover:bg-primary/5 hover:text-on-surface-strong focus-visible:underline focus:outline-hidden dark:text-on-surface-dark dark:hover:bg-primary-dark/5 dark:hover:text-on-surface-dark-strong">
                        <span>Overview</span>
                    </a>
                </li>
                <li class="border-l px-2 py-0.5 border-outline dark:border-outline-dark">
            ...
            <a href="#" class="flex items-center gap-2 mt-2 px-2 py-1.5 text-sm rounded-radius font-medium text-on-surface underline-offset-2 hover:bg-primary/5 hover:text-on-surface-strong focus-visible:underline focus:outline-hidden dark:text-on-surface-dark dark:hover:bg-primary-dark/5 dark:hover:text-on-surface-dark-strong">
                <span>Endpoints</span>
            </a>
            <ul class="pl-4">
                <li class="border-l px-2 py-0.5 border-outline dark:border-outline-dark">
                    <a href="#" class="flex items-center gap-2 px-2 py-1.5 text-sm rounded-radius text-on-surface underline-offset-2 hover:bg-primary/5 hover:text-on-surface-strong focus-visible:underline focus:outline-hidden dark:text-on-surface-dark dark:hover:bg-primary-dark/5 dark:hover:text-on-surface-dark-strong">
                        ...
                        <span class="w-fit inline-flex overflow-hidden bg-info/10 text-xs font-medium text-info">POST</span>
                    </a>
                </li>
                <li class="border-l px-2 py-0.5 border-outline dark:border-outline-dark">
                    <a href="#" class="flex items-center gap-2 px-2 py-1.5 text-sm rounded-radius text-on-surface underline-offset-2 hover:bg-primary/5 hover:text-on-surface-strong focus-visible:underline focus:outline-hidden dark:text-on-surface-dark dark:hover:bg-primary-dark/5 dark:hover:text-on-surface-dark-strong">
                        <span>Get User</span>
                        <span class="w-fit inline-flex overflow-hidden bg-success/10 text-xs font-medium text-success">GET</span>
                    </a>
                </li>
                <li class="border-l px-2 py-0.5 border-outline dark:border-outline-dark">
                    <a href="#" class="flex items-center gap-2 px-2 py-1.5 text-sm rounded-radius text-on-surface underline-offset-2 hover:bg-primary/5 hover:text-on-surface-strong focus-visible:underline focus:outline-hidden dark:text-on-surface-dark dark:hover:bg-primary-dark/5 dark:hover:text-on-surface-dark-strong">
                        <span>Update User</span>
                        <span class="w-fit inline-flex overflow-hidden bg-warning/10 text-xs font-medium text-warning">PUT</span>
                    </a>
                </li>
                <li class="border-l px-2 py-0.5 border-outline dark:border-outline-dark">
                    <a href="#" class="flex items-center gap-2 px-2 py-1.5 text-sm rounded-radius text-on-surface underline-offset-2 hover:bg-primary/5 hover:text-on-surface-strong focus-visible:underline focus:outline-hidden dark:text-on-surface-dark dark:hover:bg-primary-dark/5 dark:hover:text-on-surface-dark-strong">
                        <span>Delete User</span>
                        <span class="w-fit inline-flex overflow-hidden bg-danger/10 text-xs font-medium text-danger">DELETE</span>
                    </a>
                </li>
            </ul>
            ...
            <a href="#" class="flex items-center mt-2 gap-2 px-2 py-1.5 text-sm rounded-radius font-medium text-on-surface underline-offset-2 hover:bg-primary/5 hover:text-on-surface-strong focus-visible:underline focus:outline-hidden dark:text-on-surface-dark dark:hover:bg-primary-dark/5 dark:hover:text-on-surface-dark-strong">
