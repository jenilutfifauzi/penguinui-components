...
description: Ecommerce Product Card component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/card/ecommerce-product-card/index.html" title="Ecommerce Product Card" />

## Source

Source component: `card/ecommerce-product-card.html`
