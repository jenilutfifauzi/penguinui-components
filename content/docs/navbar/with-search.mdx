---
title: With Search
description: With Search component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/navbar/with-search/index.html" title="With Search" interaction="click" />

## Source

Source component: `navbar/with-search.html`
