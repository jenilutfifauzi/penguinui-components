---
title: Accordion With No Background
description: Accordion With No Background component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/accordion/accordion-with-no-background/index.html" title="Accordion With No Background" interaction="click" />

## Source

Source component: `accordion/accordion-with-no-background.html`
