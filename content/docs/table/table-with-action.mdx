...
description: Table With Action component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/table/table-with-action/index.html" title="Table With Action" />

## Source

Source component: `table/table-with-action.html`
