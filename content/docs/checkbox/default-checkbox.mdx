...
description: Default Checkbox component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/checkbox/default-checkbox/index.html" title="Default Checkbox" />

## Source

Source component: `checkbox/default-checkbox.html`
