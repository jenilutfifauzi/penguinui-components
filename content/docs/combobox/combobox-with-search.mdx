...
description: Combobox With Search component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/combobox/combobox-with-search/index.html" title="Combobox With Search" interaction="click" />

## Source

Source component: `combobox/combobox-with-search.html`
