...
description: Sidebar With Menu component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/sidebar/sidebar-with-menu/index.html" title="Sidebar With Menu" interaction="click" />

## Source

Source component: `sidebar/sidebar-with-menu.html`
