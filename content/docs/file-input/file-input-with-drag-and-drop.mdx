---
title: File Input With Drag And Drop
description: File Input With Drag And Drop component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/file-input/file-input-with-drag-and-drop/index.html" title="File Input With Drag And Drop" />

## Source

Source component: `file-input/file-input-with-drag-and-drop.html`
