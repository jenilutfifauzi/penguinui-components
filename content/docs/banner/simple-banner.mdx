---
title: Simple Banner
description: Simple Banner component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/banner/simple-banner/index.html" title="Simple Banner" />

## Source

Source component: `banner/simple-banner.html`
