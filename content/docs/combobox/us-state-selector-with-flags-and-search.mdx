---
title: Us State Selector With Flags And Search
description: Us State Selector With Flags And Search component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/combobox/us-state-selector-with-flags-and-search/index.html" title="Us State Selector With Flags And Search" interaction="click" />

## Source

Source component: `combobox/us-state-selector-with-flags-and-search.html`
