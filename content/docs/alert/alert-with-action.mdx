...
description: Alert With Action component built with Tailwind CSS and Alpine.js.
---

<ComponentPreview src="/preview/alert/alert-with-action/index.html" title="Alert With Action" />

## Source

Source component: `alert/alert-with-action.html`
